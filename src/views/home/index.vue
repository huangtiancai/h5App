...
<template>
  <div class="app-container">
    ...
    <van-tabbar fixed v-model="active" @change="onChange">
      <van-tabbar-item icon="column">首页</van-tabbar-item>
      <van-tabbar-item icon="todo-list">Todo</van-tabbar-item>
      <van-tabbar-item icon="setting">工具</van-tabbar-item>
      <van-tabbar-item icon="info">关于</van-tabbar-item>
